 ...
 * - Existing placement, gravity, audio, particles and WOW overlay remain untouched.
 */
  ...
  const material = new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main(){
        ...
        // ------------------------------------------------------------------
        // 2) Inclined accretion disk
        //    Thin, turbulent, and asymmetric instead of a uniform glowing ring.
        // ------------------------------------------------------------------
        ...
        // Inner material is hotter and more compact.
        float heat = 1.0 - smoothstep(0.38, 0.92, er);

        // Relativistic beaming: approaching side brighter, receding side warmer/dimmer.
        ...
        // ------------------------------------------------------------------
        // 3) Near-side band crossing the shadow
        // ------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------
        // 4) Gravitational lensing: far side appears as compressed arcs
        //    above and below the black-hole shadow.
        // ------------------------------------------------------------------
        ...
        // Thin secondary arc gives the lensing some optical complexity without glow soup.
        ...
        // ------------------------------------------------------------------
        // 5) Sparse infall streaks during the Event Horizon peak
        // ------------------------------------------------------------------
        ...
        // The shadow stays physically dark. Only the near-side accretion material
        // is allowed to cross in front of it.
        ...
        // Keep the object crisp and transparent at the edges. No circular portal glow.
...
function updateHeroVisual(renderer, scene, camera) {
  ...
  // Reuse the actual interaction gravity calculated by blackhole.js.
  ...
  // Keep all obsolete visual components off even if another frame touches them.
